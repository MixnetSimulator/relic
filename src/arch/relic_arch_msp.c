...
static volatile relic_uint_t BENCH_CYCLES_0 __asm__("0x01b2");
static volatile relic_uint_t BENCH_CYCLES_1 __asm__("0x01b4");
static volatile relic_uint_t BENCH_CYCLES_2 __asm__("0x01b6");
static volatile relic_uint_t BENCH_CYCLES_3 __asm__("0x01b8");
